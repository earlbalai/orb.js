 ...
 */
export const HUES = [13, 34, 125, 146, 166, 187, 208, 228, 249, 270, 290, 311, 332, 353];
...
export const GLSL = { VERT_HERO, FRAG_HERO, VERT_BATCH, FRAG_BATCH, GLSL_GALAXY };
...
export const PALETTES = HUES.map(makePalette);
 ...
 */
export function identityForSeed(seed) {
  const str = String(seed == null ? '' : seed);
 ...
 */
export function createAudioSource(input, opts) {
 ...
 * @param {boolean} on
 */
export function setBatching(on) {
  batchDisabled = !on;
 ...
 */
export function loseContextForTesting(restoreAfterMs = 600) {
